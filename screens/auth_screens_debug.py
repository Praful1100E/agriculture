# screens/auth_screens.py - DEBUG VERSION with logging
import re
...
class LoginScreen(Screen):
    ...
    def handle_login(self):
        ...
        print(f"DEBUG: Login attempt - Phone: '{phone}', Password length: {len(password)}")  # Debug print
        ...
        try:
            ...
            print(f"DEBUG: Auth result: {result}")  # Debug print
